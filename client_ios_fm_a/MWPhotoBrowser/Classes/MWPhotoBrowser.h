...
typedef enum {
    ACTION_ALL_TYPE_UNKNOW,     //不显示
    ACTION_ALL_TYPE_COMMON,
    ACTION_ALL_TYPE_DELETE      //删除
}MWPhotoBrowserActionAllType;
...
@property (nonatomic) MWPhotoBrowserActionAllType actionAllType;
