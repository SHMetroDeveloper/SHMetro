//
//  MaintenanceDetailMaterialItemView.m
//  client_ios_fm_a
//
...
@interface MaintenanceDetailMaterialItemView ()
...
@property (readwrite, nonatomic, strong) MaintenanceDetailMaterialModel * model;
...
@implementation MaintenanceDetailMaterialItemView
...
//    _unitLbl = [[BaseLabelView alloc] init];
    ...
    [_nameLbl setLabelText:[[BaseBundle getInstance] getStringByKey:@"order_material_name" inTable:nil] andLabelWidth:_labelWidth];
    [_brandLbl setLabelText:[[BaseBundle getInstance] getStringByKey:@"order_material_brand" inTable:nil] andLabelWidth:_labelWidth];
    [_modelLbl setLabelText:[[BaseBundle getInstance] getStringByKey:@"order_material_model" inTable:nil] andLabelWidth:_labelWidth];
//    [_unitLbl setLabelText:[[BaseBundle getInstance] getStringByKey:@"order_material_unit" inTable:nil] andLabelWidth:_labelWidth];
    [_countLbl setLabelText:[[BaseBundle getInstance] getStringByKey:@"order_material_amount" inTable:nil] andLabelWidth:_labelWidth];
...
- (void) setInfoWith:(MaintenanceDetailMaterialModel *) model{
    _model = model;
