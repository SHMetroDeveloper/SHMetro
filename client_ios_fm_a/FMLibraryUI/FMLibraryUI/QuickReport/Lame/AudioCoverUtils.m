...
//    NSString *soundFilePath = [NSTemporaryDirectory() stringByAppendingString:[NSString stringWithFormat:@"FM%lldsound.mp3",[curTime longLongValue]]];
    
    NSString *soundFilePath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0];
    soundFilePath = [soundFilePath stringByAppendingPathComponent:[NSString stringWithFormat:@"FM%lldsound.mp3",[curTime longLongValue]]];
    
//    NSURL *mp3FilePath = [NSURL fileURLWithPath:[NSTemporaryDirectory() stringByAppendingString:soundFilePath]];
    NSURL *mp3FilePath = [NSURL fileURLWithPath:soundFilePath];
