...
//    self.pageControl.currentPageIndicatorTintColor = [[[FMTheme getInstance] getColorByResource:FM_RESOURCE_TYPE_COLOR_MAIN_BLUE];
    [self.view addSubview:self.pageControl];
    
    if (!self.enterButton) {
        self.enterButton = [UIButton new];
        [self.enterButton setTitle:[[BaseBundle getInstance] getStringByKey:@"start_to_use" inTable:nil] forState:UIControlStateNormal];
...
//主界面
- (void) goToLogin {
    LoginViewController * targetVC = [[LoginViewController alloc] init];
