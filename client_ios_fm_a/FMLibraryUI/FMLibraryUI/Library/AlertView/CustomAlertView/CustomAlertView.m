...
- (void) show {
    ...
    [UIView animateWithDuration:[FMSize getInstance].defaultAnimationDuration delay:0.0 options:UIViewAnimationOptionCurveEaseInOut
					 animations:^{
...
- (void)close
{
    ...
    [UIView animateWithDuration:[FMSize getInstance].defaultAnimationDuration delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        if (i > 0) {
            UILabel * indicator = [[UILabel alloc] initWithFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - buttonHeight, 1, buttonHeight)];
            indicator.backgroundColor = [[FMTheme getInstance] getColorByResource:FM_RESOURCE_TYPE_COLOR_GRAY_L7];
