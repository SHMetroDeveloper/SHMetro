//
//  UndoRequirementViewController.m
//  client_ios_fm_a
//
...
@interface UndoRequirementViewController () <UITableViewDataSource, UITableViewDelegate, PullTableViewDelegate>
...
@implementation UndoRequirementViewController
...
//        _noticeLbl.textColor = [FMColor getInstance].mainGray;
...
- (void) initNavigation {
    [self setTitleWith:[[BaseBundle getInstance] getStringByKey:@"function_requirement_undo" inTable:nil]];
...
- (void) requestData {
    ...
    RequirementRequestParam * param = [[RequirementRequestParam alloc] initWithPage:_mPage andQueryType:REQUIREMENT_TYPE_PROCESS andCondition:nil];
