...
@interface ControctProfileBarChartView ()<ChartViewDelegate>
...
@implementation ControctProfileBarChartView
...
- (void) initViews {
    if (!_isInited) {
        ...
        _statusArray = @[[[BaseBundle getInstance] getStringByKey:@"contract_status_undo" inTable:nil],
                         [[BaseBundle getInstance] getStringByKey:@"contract_status_expired" inTable:nil],
                         ...
                         [[BaseBundle getInstance] getStringByKey:@"contract_status_verfied_NO" inTable:nil],
                         [[BaseBundle getInstance] getStringByKey:@"contract_status_verfied_YES" inTable:nil],
...
- (void)updateInfo {
    ...
    set1.barSpace = 0.55f;
    set1.colors = @[[UIColor colorWithRed:191/255.0 green:192/255.0 blue:239/255.0 alpha:255/255.0],
                    [UIColor colorWithRed:191/255.0 green:192/255.0 blue:239/255.0 alpha:255/255.0],
                    [UIColor colorWithRed:191/255.0 green:192/255.0 blue:239/255.0 alpha:255/255.0],
                    [UIColor colorWithRed:191/255.0 green:192/255.0 blue:239/255.0 alpha:255/255.0],
                    [UIColor colorWithRed:191/255.0 green:192/255.0 blue:239/255.0 alpha:255/255.0],
                    [UIColor colorWithRed:191/255.0 green:192/255.0 blue:239/255.0 alpha:255/255.0],
