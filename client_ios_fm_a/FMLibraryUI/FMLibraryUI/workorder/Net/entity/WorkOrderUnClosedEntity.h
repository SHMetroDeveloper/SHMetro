...
@interface WorkOrderUnClosedRequestParam : BaseRequest
...
@interface WorkOrderUnClosedEntity : NSObject
...
@interface WorkOrderUnClosedResponseData : NSObject
@property (readwrite, nonatomic, strong) NetPage * page;
@property (readwrite, nonatomic, strong) NSMutableArray * contents;
@end

@interface WorkOrderUnClosedResponse : BaseResponse
@property (readwrite, nonatomic, strong) WorkOrderUnClosedResponseData * data;
- (instancetype) init;
@end
